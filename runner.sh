...
export CURRENT_LABELS=location.coordinates.1,location.coordinates.0,price,id,revenue,url,residentialUnits,score,timestamp,calculated.recent,calculated.capRate,calculated.yield

export NEW_LABELS=lon,lat,price,id,revenue,url,residentialUnits,score,timestamp,recent,capRate,yield
